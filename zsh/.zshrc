...
plugins=(battery brew git osx pip vagrant lein emoji-clock tmuxinator zsh-history-substring-search zsh-syntax-highlighting git-flow git-extras per-directory-history)
...
alias cloudvr='ssh aka@cloudvr.able.cd'
# SSH - LOT204
